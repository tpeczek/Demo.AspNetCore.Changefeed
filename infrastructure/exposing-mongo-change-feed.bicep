...
var projectResourceGroupName = 'rg-exposing-mongo-change-feed' 
...
module projectResourceGroupModule 'exposing-mongo-change-feed-rg.bicep' = {
  name: 'exposing-mongo-change-feed-rg'
